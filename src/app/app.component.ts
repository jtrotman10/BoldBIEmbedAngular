...
export class AppComponent {
  ...
  public apiHost="https://oktatest.medcompli2.com";
  ...
  public rootUrl = "https://medcompliboldbi.azurewebsites.net/bi";

  //For Bold BI Enterprise edition, it should be like `site/site1`. For Bold BI Cloud, it should be empty string.
  public siteIdentifier = "site/dev";

  //Url of the GetDetails action in ValuesController of the ASP.NET Core application
  public authorizationUrl="/api/BIDashboards/getdetails";

  //Url of the GetDashboards action in ValuesController of the ASP.NET Core application
  public getDashboardsUrl="/api/BIDashboards/getdashboards";
